{ pkgs, ... }:
{
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      #bind -r D run-shell "if ! tmux list-windows -F '#{window_name}' | grep -q 'TODO.md'; then tmux neww -n 'TODO.md' -c '#{pane_current_path}' '[[ -e TODO.md ]] && nvim TODO.md'; fi"
